...
class App extends Component {
  ...
  state = { 
    projects: [
     ...
     { name: 'Untriggered', link: 'https://github.com/proiacm/untriggered', gif:'https://media.giphy.com/media/PGNdCyJiw2vtilMvIO/giphy.gif', desc: 'Ruby on Rails mood journal with Devise and OmniAuth user implementation.'}
   ]
 }
