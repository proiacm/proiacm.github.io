    ...
    return (
        <div className='Contact-img'>
            <div className='Contact' id='contact'>
                ...
                <a className='Contact-link' target='_blank' rel="noopener noreferrer" href='https://github.com/proiacm'>GitHub</a> &nbsp; | &nbsp;
                <a className='Contact-link' target='_blank' rel="noopener noreferrer" href={"mailto:" + 'proiacm@gmail.com'}>proiacm@gmail.com</a><br/><br/><br/><br/>
